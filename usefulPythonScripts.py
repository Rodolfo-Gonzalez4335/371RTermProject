...
#This script adds images that are obtained from the website image-net.org
...
#Function does the same as Negative Images Online but they are stored at a different folder
...
#Resizes an Image to desired width and Height and saves the image as a grayscale
...
#Removes not found images. This Images are created when a downloaded image from online fails
def removeNotFoundImages():
...
#Makes the descriptor files for the haar cascade training
...
#Resizes images in positive folder
